...
export default function Appointment(props) {
  ...
  return (<article className="appointment"><Header time={props.time} />
    ...
    {mode === CONFIRM && <Confirm message={"Are you sure you want to delete?"} onCancel={() => back()} onConfirm={onConfirm} />}
